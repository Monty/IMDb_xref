...
if [ "$numCategories" -lt 3 ]; then
    quantity="some of the"
    [ "$numCategories" -eq 0 ] && quantity="any of the"
    printf "==> I didn't find $quantity data files normally generated by generateXrefData.sh\n"
